...
const Footer = () => {
  return (
    <div className='bg-blue-400 text-center'>
        ...
        <ul className='flex text-black items-center justify-center gap-4 py-4'>
        ...
        <div className='items-center justify-center flex gap-6 py-12'>
        ...
        <div className='py-4 text-gray-500'>&copy; Priyanshi.All rights reserved.</div>
    </div>
  )
}
